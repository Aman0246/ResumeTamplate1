  ...
  return (
    data && (
      <>
        <div className="App">
          <button
            className="bg-blue-500 p-5 rounded text-white"
            onClick={downloadPdf}
            disabled={loading}
          >
        ...
        <div className=" bg-neutral-100  flex justify-center items-center  ">
          <div style={a4Styles} className="bg-white  mt-2  max-w-[612px] min-w-[612px]    p-4">
            <div className="flex gap-2 justify-between">
              <div className="text-[18px]  w-[80%] text-left font-semibold">
                {data?.name}
              </div>
              <div className="w-[65%] text-[12px] font-semibold  text-right  px-1">
                {data?.email}
              </div>
            </div>
            ...
            <div className="flex justify-between">
              <div className=" text-[12px] font-semibold  w-[60%]">
                {data?.location}
              </div>
            ...
            <div className=" mt-2">
              ...
              <div className="w-[100%]  resize-none text-[10px]  px-1 mt-2">
                {data?.impactICreate}
              </div>
            </div>
              ...
              {data?.professionalExperience.map((e) => (
                <>
                  <div className="flex justify-between mt-2">
                    <div type="text" className="text-[12px] font-semibold ">
                      {e?.companyName}
                    </div>
                    <div
                      type="text"
                  ...
                  <div className="w-[100%] mt-1 resize-none text-[10px]    px-1">
                    {e?.additionalDetails}
                  </div>
                </>
              ))}
            ...
            <div className="mt-2">
              ...
              {data?.projects.map((e) => (
                <>
                  <div className="flex justify-between mt-2">
                    <div className="text-[14px] font-semibold  text-sky-500 ">
                      {e?.projectName}
                    </div>
                    <div className="text-right text-[12px] font-semibold  ">
                      {e?.role}
            ...
            <div className="mt-2 ">
              ...
              {data?.achievements.map((e) => (
                <div className="my-2">
                  <div className=" text-sky-600 text-[10px] font-bold resize-none w-full">
                    {e?.achievementName}
                  </div>
                  <div className=" text-sky-500 resize-none w-full text-[10px]">
                    {e?.additionalDetails}
                  </div>
                </div>
              ))}
